...
public class OVRGrabbable : MonoBehaviour
{
    ...
    public bool _willSnap = false;
    public bool _willCheck = false;
    ...
    {
        if (selectionController) selectionController.SetSelected(gameObject);
        m_grabbedBy = hand;
    ...
    virtual public void GrabEnd(Vector3 linearVelocity, Vector3 angularVelocity)
    {
        ...
        if (_willSnap) {
            Debug.Log("snappin");
            if (selectionController) selectionController.SnapModel(gameObject);
        }
        if (_willCheck) {
            if (quizController) quizController.SnapModel(gameObject);
        }
    }
    ...
    {
        GameObject o = other.transform.gameObject;
        if (o.name == "Clear" + gameObject.name ) {
            _willSnap = true;
        }
        if (o.name == "Body") {
            _willCheck = true;
    ...
    {
        GameObject o = other.transform.gameObject;
        if (o.name == "Clear" + gameObject.name) _willSnap = false;
        if (o.name == "Body") {
            _willCheck = false;
        }
    }
